...
class PlanSubscriptionModel extends Model
{
    ...
    public function consumeFeature(string $featureCode, float $amount)
    {
        ...
        event(new \BezhanSalleh\LaravelPlans\Events\FeatureConsumed($this, $feature, $amount, $remaining));
    ...
    public function unconsumeFeature(string $featureCode, float $amount)
    {
        ...
        event(new \BezhanSalleh\LaravelPlans\Events\FeatureUnconsumed($this, $feature, $amount, $remaining));
